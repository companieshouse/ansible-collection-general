...
> [!TIP]
> `galaxy.yml` has been added to the `.gitignore` file to avoid accidental inclusion of this file in future changes. All changes should be made to the `templates/galaxy.yml.j2` template file instead.
